...
const XemDanhGiaKhongHaiLong = (props) => {
    ChartJS.register(
        CategoryScale,
        LinearScale,
        BarElement,
    ...
    const danhgia = [
        ...
        {
            ngay: '2023-10-11',
            noidung: 'Nhân viên tiếp tân Lan nói chuyện rất cọc cằn',
        },
        {
            ngay: '2023-10-13',
            noidung: 'Chất lượng không tương xứng với giá tiền phải bỏ ra',
        },
    ];
...
export default XemDanhGiaKhongHaiLong;