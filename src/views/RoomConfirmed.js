        ...
        <div>
            ...
            <section>
                <div className="container mt-4">
                    ...
                    <p style={{ fontSize: '24px' }}>Số lượng người ở tối đa: {bookingInfo.soLuongNguoiToiDa}/phòng</p>
                </div>
            </section>
                ...
                <div className="container mt-4">
                    ...
                    <form >
                        <div className='row'>
                            ...
                            <div className="col-3 mb-3">
                                <input className='form-control' style={{ fontSize: '24px', height: '90px', borderRadius: '9px', borderColor: '#905700' }} type='number' placeholder='Số lượng phòng' />
                            </div>
                            <div className="col-3 mb-3">
